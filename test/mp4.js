...
var MP4Reader = (function reader() {
  ...
  constructor.prototype = {
    ...
    readBox: function readBox(stream) {
      var box = { offset: stream.position+offsetWS };
...
var MP4Player = (function reader() {
  ...
  function constructor(stream, useWorkers, webgl, render) {
    ...
    this.onBeforeDecodingNal = function (nal) {};
    ...
    this.avc.onPictureDecoded = function(buffer, width, height, infos){
      ...
      self.onFrameDecoded(buffer, width, height);
    };
  ...
  constructor.prototype = {
    ...
    onBeforeDecodingNal : function(nal) {
...
var Broadway = (function broadway() {
  function constructor(div) {
    ...
    this.player.onFrameDecoded = function (buffer, width, height) {
      this.onFrameDecoded(buffer, width, height);
    }.bind(this);
    this.player.onBeforeDecodingNal = function (nal) {
      this.onBeforeDecodingNal(nal);
    }.bind(this);
  ...
  constructor.prototype = {
    ...
    onFrameDecoded:function(buffer, width, height) {},
    onBeforeDecodingNal:function(nal) {}
  };
  return constructor;
})();
